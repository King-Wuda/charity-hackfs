...
const listData = [
  {
    ...
    amountRequired: 2,
    address: "0x0C13DCfc50a466a63692C518239E036bd1fc117C",
  },
  {
...
export default function Activity() {
  ...
  const handleDonateToCause = (e) => {
    console.log(e);
    Donate(0, "0x0C13DCfc50a466a63692C518239E036bd1fc117C");
  ...
  return (
    <Layout>
      ...
      <ActivityList
        ...
        onDonationToggle={handleDonationModalToggle}
        dataSource={causeList}
        listTitle="Causes"
      />

      <Modal
        title="Tell us about your cause"
        visible={causeForm}
        onCancel={handleCauseFormToggle}
        footer={null}
      >
      ...
      <Modal
        ...
        onCancel={handleDonationModalToggle}
        footer={null}
      >
  ...
  return (
    ...
    >
      <Form.Item
        name="name"
        rules={[
          { required: true, message: "Please provide a name for your cause!" },
        ]}
        label="Cause name"
      >
